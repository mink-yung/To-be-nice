...
import { newLionId } from '../utils/randomUser.js';
import {
  isValidEmail,
  isValidPhone,
  isValidWebsiteUrl,
  parseSkills,
} from '../utils/lionsValidation.js';
import { useDocumentEscape } from '../hooks/useDocumentEscape.js';
...
function LionAddFormShell({
  ...
  useEffect(() => {
    if (!formPrefillLion) return;
    setForm(lionToForm(formPrefillLion));
    setErrors({});
    onFormPrefillConsumed();
  }, [formPrefillLion]);
